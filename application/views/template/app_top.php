...
<head>
    ...
    <meta name="author" content="Ferdy Hartanto P">
    <link rel="icon" type="image/x-icon" href="<?= base_url('public/icon.png') ?>">
    <title><?= APP_NAME . ' &mdash; ' . AUTHOR_NAME  ?></title>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column mt-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= activeMenu('index/pendaftarmandiripres', 'active') ?>" href="<?= site_url('index/pendaftarmandiripres') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= activeMenu('index/pendapatanbank', 'active') ?>" href="<?= site_url('index/pendapatanbank') ?>">
                                <span data-feather="list" class="align-text-bottom"></span>
                                Grafik Pendapatan
                            </a>
                        </li>
